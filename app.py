...
# 🌈 Page Configuration
st.set_page_config(page_title="Mood Roast", page_icon="🔥", layout="wide")
...
# 🎛️ Sidebar
with st.sidebar:
    st.header("✨ Mood Roast Me Settings")
    st.markdown("""
        Welcome to **Mood Roast Me** 💣 – where sass meets sweet. 
    ...
    """)
    st.markdown("---")
    st.info("Made with ❤️ by Rabiya the Savage 👸")
...
# 👣 Footer
st.markdown("---")
st.caption("Made with fire & love 🔥💖 by Rabiya")